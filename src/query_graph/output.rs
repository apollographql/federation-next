...
use crate::query_graph::{FederatedQueryGraph, FederatedQueryGraphEdge, FederatedQueryGraphNode};
use apollo_compiler::NodeStr;
use petgraph::graph::{DiGraph, EdgeIndex};
use petgraph::stable_graph::StableGraph;

type InnerGraph = DiGraph<FederatedQueryGraphNode, FederatedQueryGraphEdge>;
type StableInnerGraph = StableGraph<FederatedQueryGraphNode, FederatedQueryGraphEdge>;

//////////////////////////////////////////////////////////////////////////////
// GraphViz output for QueryGraph

fn label_edge(edge: &FederatedQueryGraphEdge) -> String {
...
fn label_node(_node: &FederatedQueryGraphNode) -> String {
    todo!()
    // format!("label=\"{}\"", node.type_)
}

pub fn to_dot(_graph: &FederatedQueryGraph) -> String {
    todo!()
...
fn to_dot_federated(_graph: &FederatedQueryGraph) -> Result<String, std::fmt::Error> {
    fn edge_within_cluster(
        _graph: &StableInnerGraph,
        _cluster_name: &NodeStr,
    ...
    fn edge_across_clusters(_graph: &StableInnerGraph, _edge_index: EdgeIndex) -> bool {
        todo!()
        // graph
    ...
    fn label_cluster_node(_node: &FederatedQueryGraphNode) -> String {
        todo!()
