...
mod tests {
    ...
    #[test]
    fn handles_types_having_no_fields_referenced_by_other_objects_in_a_subgraph_correctly() {
        /*
         ...
         * The following supergraph has been generated from:
            ...
            pbpaste | rover supergraph compose --config - | pbcopy
