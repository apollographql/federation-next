...
impl JoinSpecDefinition {
    ...
    pub fn graph_directive_arguments<'schema>(
        &self,
    ...
    pub fn type_directive_definition<'schema, T: AsRef<OptionLinksMetadata>>(
        &self,
        schema: &FederationSchemaRef<'schema, T>,
    ) -> &'schema Node<DirectiveDefinition> {
    ...
    pub fn type_directive_arguments<'schema>(
        &self,
        application: &'schema Node<Directive>,
    ...
    pub fn field_directive_definition<'schema, T: AsRef<OptionLinksMetadata>>(
        &self,
        schema: &FederationSchemaRef<'schema, T>,
    ) -> &'schema Node<DirectiveDefinition> {
    ...
    pub fn field_directive_arguments<'schema>(
        &self,
        application: &'schema Node<Directive>,
    ...
    pub fn implements_directive_definition<'schema, T: AsRef<OptionLinksMetadata>>(
        &self,
        schema: &FederationSchemaRef<'schema, T>,
    ...
    pub fn implements_directive_arguments<'schema>(
        &self,
        application: &'schema Node<Directive>,
    ...
    pub fn union_member_directive_definition<'schema, T: AsRef<OptionLinksMetadata>>(
        &self,
        schema: &FederationSchemaRef<'schema, T>,
    ) -> Option<&'schema Node<DirectiveDefinition>> {
    ...
    pub fn union_member_directive_arguments<'schema>(
        &self,
        application: &'schema Node<Directive>,
    ...
    pub fn enum_value_directive_definition<'schema, T: AsRef<OptionLinksMetadata>>(
        &self,
        schema: &FederationSchemaRef<'schema, T>,
    ) -> Option<&'schema Node<DirectiveDefinition>> {
        if *self.version() < (Version { major: 0, minor: 3 }) {
    ...
    pub fn enum_value_directive_arguments<'schema>(
        &self,
        application: &'schema Node<Directive>,
