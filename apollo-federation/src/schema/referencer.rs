...
pub fn referencers(schema: &Schema) -> Referencers {
    ...
    for directive_reference in schema.schema_definition.directives.iter() {
        referencers
            .directives
    ...
    if let Some(ref query_root_type) = schema.schema_definition.query {
        referencers
            .object_types
    ...
    if let Some(ref mutation_root_type) = schema.schema_definition.mutation {
        referencers
            .object_types
    ...
    if let Some(ref subscription_root_type) = schema.schema_definition.subscription {
        referencers
            .object_types
