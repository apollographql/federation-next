...
impl SchemaDefinitionLocation {
    pub fn get<'schema>(&self, schema: &'schema Schema) -> &'schema Node<SchemaDefinition> {
    ...
    pub fn try_get<'schema>(
        ...
        Some(&schema.schema_definition)
    }

    pub fn make_mut<'schema>(
        &self,
...
impl SchemaRootDefinitionLocation {
    ...
    pub fn get<'schema>(&self, schema: &'schema Schema) -> &'schema ComponentStr {
        let schema_definition = self.parent().get(schema);

        match self.root_kind {
            SchemaRootDefinitionKind::Query => match schema_definition.query.as_ref() {
                Some(root) => root,
                None => panic!("Schema definition has no query root type"),
            },
            SchemaRootDefinitionKind::Mutation => match schema_definition.mutation.as_ref() {
                Some(root) => root,
                None => panic!("Schema definition has no mutation root type"),
            },
            SchemaRootDefinitionKind::Subscription => match schema_definition.subscription.as_ref()
            {
                Some(root) => root,
    ...
    pub fn try_get<'schema>(&self, schema: &'schema Schema) -> Option<&'schema ComponentStr> {
    ...
    pub fn make_mut<'schema>(&self, schema: &'schema mut Schema) -> &'schema mut ComponentStr {
...
impl ScalarTypeDefinitionLocation {
    pub fn get<'schema>(&self, schema: &'schema Schema) -> &'schema Node<ScalarType> {
    ...
    pub fn try_get<'schema>(&self, schema: &'schema Schema) -> Option<&'schema Node<ScalarType>> {
        match schema.types.get(&self.type_name) {
    ...
    pub fn make_mut<'schema>(&self, schema: &'schema mut Schema) -> &'schema mut Node<ScalarType> {
...
impl ObjectTypeDefinitionLocation {
    pub fn get<'schema>(&self, schema: &'schema Schema) -> &'schema Node<ObjectType> {
        match schema.types.get(&self.type_name) {
    ...
    pub fn try_get<'schema>(&self, schema: &'schema Schema) -> Option<&'schema Node<ObjectType>> {
        match schema.types.get(&self.type_name) {
    ...
    pub fn make_mut<'schema>(&self, schema: &'schema mut Schema) -> &'schema mut Node<ObjectType> {
        match schema.types.get_mut(&self.type_name) {
...
impl ObjectFieldDefinitionLocation {
    ...
    pub fn get<'schema>(&self, schema: &'schema Schema) -> &'schema Component<FieldDefinition> {
...
impl ObjectFieldArgumentDefinitionLocation {
    ...
    pub fn get<'schema>(&self, schema: &'schema Schema) -> &'schema Node<InputValueDefinition> {
        let parent = self.parent();
        let type_ = parent.get(schema);
...
impl InterfaceTypeDefinitionLocation {
    pub fn get<'schema>(&self, schema: &'schema Schema) -> &'schema Node<InterfaceType> {
        match schema.types.get(&self.type_name) {
...
impl UnionTypeDefinitionLocation {
    pub fn get<'schema>(&self, schema: &'schema Schema) -> &'schema Node<UnionType> {
        match schema.types.get(&self.type_name) {
    ...
    pub fn try_get<'schema>(&self, schema: &'schema Schema) -> Option<&'schema Node<UnionType>> {
        match schema.types.get(&self.type_name) {
    ...
    pub fn make_mut<'schema>(&self, schema: &'schema mut Schema) -> &'schema mut Node<UnionType> {
        match schema.types.get_mut(&self.type_name) {
...
impl EnumTypeDefinitionLocation {
    pub fn get<'schema>(&self, schema: &'schema Schema) -> &'schema Node<EnumType> {
        match schema.types.get(&self.type_name) {
    ...
    pub fn try_get<'schema>(&self, schema: &'schema Schema) -> Option<&'schema Node<EnumType>> {
        match schema.types.get(&self.type_name) {
    ...
    pub fn make_mut<'schema>(&self, schema: &'schema mut Schema) -> &'schema mut Node<EnumType> {
        match schema.types.get_mut(&self.type_name) {
...
impl EnumValueDefinitionLocation {
    ...
    pub fn get<'schema>(&self, schema: &'schema Schema) -> &'schema Component<EnumValueDefinition> {
        let parent = self.parent();
        let type_ = parent.get(schema);
...
impl InputObjectTypeDefinitionLocation {
    pub fn get<'schema>(&self, schema: &'schema Schema) -> &'schema Node<InputObjectType> {
        match schema.types.get(&self.type_name) {
...
impl DirectiveDefinitionLocation {
    pub fn get<'schema>(&self, schema: &'schema Schema) -> &'schema Node<DirectiveDefinition> {
